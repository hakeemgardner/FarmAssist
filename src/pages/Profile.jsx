...
import {
  UpdateCurrentUser,
  UpdateCurrentUserId,
} from "../database/farmer_service/update_service";
      ...
      <div className="min-h-screen bg-[#fffdf6] font-sans text-gray-800">
        <main className="max-w-5xl mx-auto p-6">
          ...
          <div className="bg-white shadow-md border border-gray-100 rounded-xl p-6 flex justify-between items-center mb-10">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">
                  ...
                  {_userInfo?.created_at
                    ? new Date(_userInfo.created_at).getFullYear()
                    : "2025"}
                </p>
              </div>
            </div>
            <button
              onClick={logoutUser}
              className="bg-green-400 hover:bg-green-500 text-sm font-semibold px-4 py-2 rounded-md transition"
            >
              <svg
              ...
              >
                <title>Logout</title>
                <path
                  d="M10 17v2a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v2"
                  stroke="currentColor"
                  stroke-width="1.6"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setuserInfo({ ..._userInfo, name: e.target.value })
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setuserInfo({ ..._userInfo, telephone: e.target.value })
                    }
                    className="w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-green-400 outline-none"
                  />
                </div>
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setuserInfo({ ..._userInfo, parish: e.target.value })
                    }
                    className="w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-green-400 outline-none"
                  >
          ...
          <div className="mt-10">
            ...
            {products.length === 0 ? (
              <div className="text-center py-10 text-gray-500">
                <p>
                  No products found. Start adding products to your marketplace!
                </p>
              </div>
            ) : (
